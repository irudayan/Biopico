            ...
            <div class="content-inner">
                ...
                <form method="POST" action="mail.php">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <input class="gray form-control allow_decimal" type="text" id="vol_endo_thrombin_mix" name="vol_endo_thrombin_mix" value="5000" readonly>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span>ul </span>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <input class="gray form-control allow_decimal" type="text" id="vol_peri_thrombin_mix" name="vol_peri_thrombin_mix" value="2000" readonly>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span>ul </span>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <input class="gray form-control allow_decimal" type="text" id="vol_astro_thrombin_mix" name="vol_astro_thrombin_mix" value="2000" readonly>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span>ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label for="fa_occu">74.&nbsp;&nbsp;Volume of Astrocytes resuspension left</label>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
