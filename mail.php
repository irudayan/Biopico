...
$mail->Username = 'irudya@dbcyelagiri.edu.in'; // YOUR gmail email
$mail->Password = 'diasvin196'; // YOUR gmail password

// Sender and recipient settings
$mail->setfrom('irudya@dbcyelagiri.edu.in', "BBB Organ");
//$mail->addaddress('preethi@dbcyelagiri.edu.in');
$mail->addaddress($email);
$mail->addaddress('irudya@dbcyelagiri.edu.in');
...
{
    echo "<script type='text/javascript'> window.location.href='form.php?mail=success';</script>";
 
//echo "<script> window.location = './form.php'; alert('Successfully Updated');</script>";
}