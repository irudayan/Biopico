    ...
    <section class="admission-form">
        <div class="container">
            <div class="content-inner">
                ...
                <form method="POST" action="https://biopico.com/Form/mail2.php">

                    <div class="row">
                        <legend>Legend</legend>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <label for="name">2.&nbsp;&nbsp;User Input</label>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="green form-control allow_decimal" type="text" readonly>
                        </div>
                      
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <label for="name">3.&nbsp;&nbsp;Calculated Output</label>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <input class="yellow form-control allow_decimal" type="text" readonly >
                        </div>

                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <label for="name">4.&nbsp;&nbsp;Intermediate Values (cannot be edited)</label>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <input class="form-control allow_decimal" type="text" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <p></p>
                        ...
                        <!-- Liver -->
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <input class="form-check-input" type="radio" name="flexRadioLiver" value="0" id="flexRadioLiver0" onchange="calculate1(this, 'Liver');">
                                <label class="form-check-label" for="flexRadioLiver0">
                                    0
                                </label>
                                <input class="form-check-input" type="radio" name="flexRadioLiver" value="1" id="flexRadioLiver1" checked onchange="calculate1(this, 'Liver');">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <input class="form-check-input" type="radio" name="flexRadioGut" value="0" id="flexRadioGut0" onchange="calculate1(this, 'Gut');">
                                <label class="form-check-label" for="flexRadioGut0">
                                    0
                                </label>
                                <input class="form-check-input" type="radio" name="flexRadioGut" value="1" id="flexRadioGut1" checked onchange="calculate1(this, 'Gut');">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <input class="form-check-input" type="radio" name="flexRadioBrain" value="0" id="flexRadioBrain0" onchange="calculate1(this, 'Brain');">
                                <label class="form-check-label" for="flexRadioBrain0">
                                    0
                                </label>
                                <input class="form-check-input" type="radio" name="flexRadioBrain" value="1" id="flexRadioBrain1" checked onchange="calculate1(this, 'Brain');">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <input class="form-check-input" type="radio" value="0" name="vascularRadioLiver" id="flexRadioVascularLiver0" onchange="calculate1(this, 'VascularLiver');">
                                <label class="form-check-label" for="flexRadioVascularLiver0">
                                    0
                                </label>
                                <input class="form-check-input" type="radio" value="1" name="vascularRadioLiver" id="flexRadioVascularLiver1" checked onchange="calculate1(this, 'VascularLiver');">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <input class="form-check-input" type="radio" name="vascularRadioKidney" id="flexRadioVascularKidney0" value="0" onchange="calculate1(this,'VascularKidney');">
                                <label class="form-check-label" for="flexRadioVascularKidney0">
                                    0
                                </label>
                                <input class="form-check-input" type="radio" name="vascularRadioKidney" id="flexRadioVascularKidney1" value="1" checked onchange="calculate1(this,'VascularKidney');">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <input class="form-check-input" type="radio" name="vascularRadioGut" id="flexRadioVascularGut0" value="0" onchange="calculate1(this,'VascularGut');">
                                <label class="form-check-label" for="flexRadioVascularGut0">
                                    0
                                </label>
                                <input class="form-check-input" type="radio" name="vascularRadioGut" id="flexRadioVascularGut1" value="1" checked onchange="calculate1(this,'VascularGut');">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <input class="form-check-input" type="radio" name="vascularRadioBrain" id="flexRadioVascularBrain0" value="0" onchange="calculate1(this,'VascularBrain');">
                                <label class="form-check-label" for="flexRadioVascularBrain0">
                                    0
                                </label>
                                <input class="form-check-input" type="radio" name="vascularRadioBrain" id="flexRadioVascularBrain1" value="1" checked onchange="calculate1(this,'VascularBrain');">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="tol_vol_liver" name="tol_vol_liver" value="15" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="vol_gel_mix_liver" required name="vol_gel_mix_liver" value="450" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="tot_gel_plate_liver" name="tot_gel_plate_liver" value="450" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" id="tol_kid" name="tol_kid" value="6.25" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="gel_mix_plate_kid" value="187.5" name="gel_mix_plate_kid" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" id="total_gel_kid" name="total_gel_kid" value="187.5" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="tol_gut" name="tol_gut" value="5" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="gel_mix_gut" name="gel_mix_gut" value="150" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="total_gel_gut" name="total_gel_gut" value="150" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="tol_brain" name="tol_brain" value="6.25" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" id="gel_mix_brain" name="gel_mix_brain" value="187.5" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" id="total_gel_brain" name="total_gel_brain" value="187.5" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" id="vol_liver_endo" name="vol_liver_endo" value="450" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" id="vol_kid_endo" name="vol_kid_endo" value="187.5" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="vol_gut_endo" name="vol_gut_endo" value="150" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="vol_brain_endo" name="vol_brain_endo" value="187.5" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="total_endo_vol" name="total_endo_vol" value="975" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                      <p></p>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="total_gel_need" name="total_gel_need" value="1950" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="total_fib_gel" name="total_fib_gel" value="650" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="mass_phenol_pbs" name="mass_phenol_pbs" value="1.3" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="yellow form-control allow_decimal" type="text" id="vol_pbs_phenol" name="vol_pbs_phenol" value="650" readonly >
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="yellow form-control allow_decimal" type="text" id="fib_powder" name="fib_powder" value="3.9" readonly >
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> mg </span>
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> U/mg </span>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <label for="fa_occu">65.&nbsp;&nbsp;Solid in bottle</label>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="solid_bottle" name="solid_bottle" value="9.900990099" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> mg </span>
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ml </span>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <label for="fa_occu">69.&nbsp;&nbsp;Thrombin stock solution concentration in mg/ml</label>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="throm_sol_con" name="throm_sol_con" value="9.900990099" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> mg/ml </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="tot_gel_work" name="tot_gel_work" value="650" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="throm_work_sol" name="throm_work_sol" value="26" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="vol_hep_con" name="vol_hep_con" value="624" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="hep_thromb_sol" name="hep_thromb_sol" value="650" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <label for="fa_occu">79.&nbsp;&nbsp;Number of Liver cells from T- flask</label>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" id="tot_liver_cell" name="tot_liver_cell" value="12400000" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" id="tot_kid_cell" name="tot_kid_cell" value="7000000" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" id="tot_gut_cell" name="tot_gut_cell" value="10000000" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" id="tot_brain_cell" name="tot_brain_cell" value="2000000" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" id="tot_endo_cell" name="tot_endo_cell" value="10000000" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" id="tot_fib_cell" name="tot_fib_cell" value="12000000" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells </span>
                        </div>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells/ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="cells_req_exp_liv" name="cells_req_exp_liv" value="4500000" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" id="res_cell_dens_liv" name="res_cell_dens_liv" value="30000" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells/ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="yellow form-control allow_decimal" type="text" id="res_vol_liv" name="res_vol_liv" value="413.33" readonly >
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="yellow form-control allow_decimal" type="text" id="vol_throm_mix_liv" name="vol_throm_mix_liv" value="150" readonly >
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="vol_res_left_liv" name="vol_res_left_liv" value="263.33" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="cell_remain_liv" name="cell_remain_liv" value="7899900" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="working_solution_liv" name="working_solution_liv" value="150" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="fibrinogen_solution_liv" name="fibrinogen_solution_liv" value="150" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="cells_req_exp_kid" name="cells_req_exp_kid" value="6562500" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" id="res_cell_dens_kid" name="res_cell_dens_kid" value="105000" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells/ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="yellow form-control allow_decimal" type="text" id="res_vol_kid" name="res_vol_kid" value="66.67" readonly >
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="yellow form-control allow_decimal" type="text" id="vol_throm_mix_kid" name="vol_throm_mix_kid" value="62.5" readonly >
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="vol_res_left_kid" name="vol_res_left_kid" value="4.17" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="cell_remain_kid" name="cell_remain_kid" value="437850" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="working_solution_kid" name="working_solution_kid" value="62.5" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="fibrinogen_solution_kid" name="fibrinogen_solution_kid" value="62.5" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="cells_req_exp_gut" name="cells_req_exp_gut" value="1500000" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" id="res_cell_dens_gut" name="res_cell_dens_gut" value="30000" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells/ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="yellow form-control allow_decimal" type="text" id="res_vol_gut" name="res_vol_gut" value="333.3333333333333" readonly >
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="yellow form-control allow_decimal" type="text" id="vol_throm_mix_gut" name="vol_throm_mix_gut" value="62.5" readonly >
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="vol_res_left_gut" name="vol_res_left_gut" value="270.8333333333333" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="cell_remain_gut" name="cell_remain_gut" value="8124999.999999999" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="working_solution_gut" name="working_solution_gut" value="62.5" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="fibrinogen_solution_gut" name="fibrinogen_solution_gut" value="62.5" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="cells_req_exp_brain" name="cells_req_exp_brain" value="61875" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" id="res_cell_dens_brain" name="res_cell_dens_brain" value="990" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells/ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="yellow form-control allow_decimal" type="text" id="res_vol_brain" name="res_vol_brain" value="2020.20202020202" readonly >
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="yellow form-control allow_decimal" type="text" id="vol_throm_mix_brain" name="vol_throm_mix_brain" value="50" readonly >
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="vol_res_left_brain" name="vol_res_left_brain" value="1970.20202020202" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="cell_remain_brain" name="cell_remain_brain" value="1950500" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="working_solution_brain" name="working_solution_brain" value="50" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="fibrinogen_solution_brain" name="fibrinogen_solution_brain" value="50" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="cells_req_exp_endo" name="cells_req_exp_endo" value="4875000" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" type="text" id="res_cell_dens_endo" name="res_cell_dens_endo" value="30000" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells/ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="yellow form-control allow_decimal" type="text" id="res_vol_endo" name="res_vol_endo" value="333.3333333333333" readonly >
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="yellow form-control allow_decimal" type="text" id="vol_throm_mix_endo" name="vol_throm_mix_endo" value="325" readonly>
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="vol_res_left_endo" name="vol_res_left_endo" value="8.3333333333333" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="cell_remain_endo" name="cell_remain_endo" value="249999.99999999" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> cells </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="working_solution_endo" name="working_solution_endo" value="325" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control allow_decimal" type="text" id="fibrinogen_solution_endo" name="fibrinogen_solution_endo" value="325" readonly style="background-color: #d3d3d3 ;">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span class="color"> ul </span>
                        </div>
...
// Gut
            if ($('#des_dens_org_gut').val() != '') {
                ...
                var resVolGut = $('#res_vol_gut').val($('#tot_gut_cell').val() / $('#res_cell_dens_gut').val());
                var volThrombMixGut = $('#vol_throm_mix_gut').val($('#total_gel_brain').val() / 3);
                var volResLeftGut = $('#vol_res_left_gut').val($('#res_vol_gut').val() - $('#vol_throm_mix_gut').val());
                var cellRemainGut = $('#cell_remain_gut').val($('#vol_res_left_gut').val() * $('#res_cell_dens_gut').val());
                var volThromWorSolGut = $('#working_solution_gut').val($('#vol_throm_mix_gut').val());
                var volThromFibSolGut = $('#fibrinogen_solution_gut').val($('#vol_throm_mix_gut').val());
            }
...
// brain
            if ($('#des_dens_org_brain').val() != '') {
                ...
                var resVolBrain = $('#res_vol_brain').val($('#tot_brain_cell').val() / $('#res_cell_dens_brain').val());
                var volThrombMixBrain = $('#vol_throm_mix_brain').val($('#total_gel_gut').val() / 3 );
                var volResLeftBrain = $('#vol_res_left_brain').val($('#res_vol_brain').val() - $('#vol_throm_mix_brain').val());
                var cellRemainBrain = $('#cell_remain_brain').val($('#vol_res_left_brain').val() * $('#res_cell_dens_brain').val());
                var volThromWorSolBrain = $('#working_solution_brain').val($('#vol_throm_mix_brain').val());
                var volThromFibSolBrain = $('#fibrinogen_solution_brain').val($('#vol_throm_mix_brain').val());
            }
...
// Endothelial cells / Fibroblast for Outer Channels
            ...
            if ($('#des_dens_org_endo').val() !== '') {
                ...
                var resCellDensityEndo = $('#res_cell_dens_endo').val($('#cells_req_exp_endo').val() / $('#total_endo_vol').val() * $('#no_of_units').val());
                var resVolEndo = $('#res_vol_endo').val($('#tot_endo_cell').val() / $('#res_cell_dens_endo').val());


                    
                // now work
                var selectedValue = $('input[name="flexRadio" + organ]:checked').val();
                if (organ === 'VascularLiver' || organ === 'VascularKidney' || organ === 'VascularGut' || organ === 'VascularBrain') {
        var volThrombMixEndo = $('#vol_throm_mix_endo');
        var liverValue = $('#vol_throm_mix_liv').val() * $('#flexRadioVascularLiver0').val();
        var kidneyValue = $('#vol_throm_mix_kid').val() * $('#flexRadioVascularKidney0').val();
        var brainValue = $('#vol_throm_mix_brain').val() * $('#flexRadioVascularBrain0').val();
        var gutValue = $('#vol_throm_mix_gut').val() * $('#flexRadioVascularGut0').val();
        var totalValue = liverValue + kidneyValue + brainValue + gutValue;

        volThrombMixEndo.val(totalValue);
    }
    
    if (selectedValue === '1') {
        var volThrombMixEndo = $('#vol_throm_mix_endo');
        var liverValue = $('#vol_throm_mix_liv').val() * $('#flexRadioVascularLiver1').val();
        var kidneyValue = $('#vol_throm_mix_kid').val() * $('#flexRadioVascularKidney1').val();
        var brainValue = $('#vol_throm_mix_brain').val() * $('#flexRadioVascularGut1').val();
        var gutValue = $('#vol_throm_mix_gut').val() * $('#flexRadioVascularBrain1').val();
        var totalValue = liverValue + kidneyValue + brainValue + gutValue;
        ...
        volThrombMixEndo.val(totalValue);
                    ...
                    var volResLeftEndo = $('#vol_res_left_endo').val($('#res_vol_endo').val() - $('#vol_throm_mix_endo').val());
                    var cellRemainEndo = $('#cell_remain_endo').val($('#vol_res_left_endo').val() * $('#res_cell_dens_endo').val());

                    var volThromWorSolEndo = $('#working_solution_endo').val($('#vol_throm_mix_endo').val());
                    var volThromFibSolEndo = $('#fibrinogen_solution_endo').val($('#vol_throm_mix_endo').val());
            }
        }
    </script>
