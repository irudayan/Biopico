    ...
    <section class="admission-form">
        <div class="container">
            <div class="content-inner">
                ...
                <form method="POST" action="https://biopico.com/Form/mail.php">
                   <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <input class="gray form-control allow_decimal" type="text" id="total_fib_gel" value="150" readonly name="total_fib_gel">
                        </div>
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span> ul </span>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input class="gray form-control" type="text" id="phenol_red_pbs" name="phenol_red_pbs" value="0.3" readonly >
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span> mg </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <input class="yellow form-control allow_decimal" type="text" id="vol_pbs_phenol" name="vol_pbs_phenol" value="150" readonly>
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                              <span> ml </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input class="yellow form-control" type="text" id="fibrin_powder" name="fibrin_powder" value="0.90" readonly>
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                              <span> mg </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <input class="gray form-control allow_decimal" type="text" id="req_thrombin_gel" name="req_thrombin_gel" value="45" readonly>
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span> ul </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input class="green form-control allow_decimal" type="text" id="con_thromb_sol" name="con_thromb_sol" value="10" onkeyup="calculate1();" required  onInput="this.value=this.value.replace(/[^0-9\.]/g,'');">
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                              <span> U/ml </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input class="yellow form-control allow_decimal" type="text" id="vol_thromb_sol" name="vol_thromb_sol" value="4.5"  readonly >
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                              <span> ul </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input class="yellow form-control allow_decimal" type="text" id="thrombin_pbs" name="thrombin_pbs" value="40.5" readonly >
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                              <span> ul </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input class="gray form-control allow_decimal" type="text" id="thrombin_gel_making" name="thrombin_gel_making" value="150" readonly >
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                              <span> ul </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input class="green form-control allow_decimal" type="text" id="thromb_con" name="thromb_con" value="3" onkeyup="calculate1();" required onInput="this.value=this.value.replace(/[^0-9\.]/g,'');">
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                              <span> U/ml </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input class="gray form-control allow_decimal" type="text" id="thromb_working_sol" name="thromb_working_sol" value="45" readonly >
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                              <span> ul </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input class="yellow form-control allow_decimal" type="text" id="vol_heparin" name="vol_heparin" value="105" readonly>
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                              <span> ul </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input class="gray form-control allow_decimal" type="text" id="heparin_thromb" name="heparin_thromb"  value="150" readonly >
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                              <span> ul </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input class="green form-control allow_decimal" type="text" id="no_of_endo"  name="no_of_endo" value="2400000"  onkeyup="calculate1();" onInput="this.value=this.value.replace(/[^0-9\.]/g,'');" required>
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                              <span> cells </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <input class="gray form-control" type="text" id="total_endo" name="total_endo" value="2400000"  readonly>
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <span> cells </span>
                          </div>
                         ...
                         <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input class="yellow form-control" type="text" id="res_vol_endo"  name="res_vol_endo" value="160" readonly>
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                              <span> ul </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input class="gray form-control allow_decimal" type="text" id="vol_endo_res" name="vol_endo_res" value="60" onInput="this.value=this.value.replace(/[^0-9\.]/g,'');" required>
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                              <span> ul </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input class="gray form-control" type="text" id="vol_peri_res" name="vol_peri_res" value="400" readonly>
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                          <span> ul </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input class="gray form-control" type="text" id="vol_astro_res" name="vol_astro_res" value="122.2222" readonly>
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                          <span> ul </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input class="gray form-control" type="text" id="no_endo_remain" name="no_endo_remain" value="900000" readonly>
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                          <span> cells </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input class="gray form-control allow_decimal" type="text" id="no_peri_remain" name="no_peri_remain" value="2400000" onInput="this.value=this.value.replace(/[^0-9\.]/g,'');" required>
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                          <span> cells </span>
                          </div>
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <input class="gray form-control" type="text" id="no_astro_remain" name="no_astro_remain" value="1100000" readonly>
                          </div>
                          <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                          <span> cells </span>
                          </div>
